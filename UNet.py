...
class UNet(nn.Module):
    def __init__(self, 
        ...
        # Up path: n_blocks+1 blocks with skip connections
...
def get_timestep_embedding(
    ...
    timesteps = timesteps * 1000.0  # In DDPM the time step is in [0, 1000], here [0, 1]
